...
<style>
  :host {
    --button-primary-background-color: var(--color-primary, #ffd464);
    --button-default-background-color: white;
    --button-secondary-background-color: var(--color-secondary, #8241a4);
  }
...
export default {
  ...
  render: ({ type, disabled, label }) => html`
    ${style}
    <button
        onclick="${onClick}"
        class="${type} ${getDisabledClass(disabled)}">
        ${label}
    </button>
  `
};